...
import { FaGithub, FaCode, FaCalendarAlt, FaStar, FaExclamationTriangle } from 'react-icons/fa';
      ...
      >
        ...
        <div className="mt-4 text-xs text-gray-500">
          ...
          <ul className="list-disc list-inside mt-2 space-y-1">
            <li>Created a GitHub Personal Access Token</li>
            <li>Added VITE_GITHUB_TOKEN to your .env file</li>
            <li>Added VITE_GITHUB_USERNAME to your .env file</li>
